              ...
              <motion.div
                ...
                <Link
                  ...
                  <div className="h-4 w-4">
                    {hoveredItem === idx && item.hoverIcon ? item.hoverIcon : item.icon}
                  </div>
                </Link>
              </motion.div>
            ))}
...
function IconContainer({
  ...
  // Handle icon change based on hover state
  const displayIcon = hovered && hoverIcon ? hoverIcon : icon;
        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="px-2 py-0.5 whitespace-pre rounded-md bg-neutral-800 border border-neutral-900 text-white absolute left-1/2 -translate-x-1/2 -top-8 w-fit text-xs z-20">
              {title}
            </motion.div>
          )}
        </AnimatePresence>
